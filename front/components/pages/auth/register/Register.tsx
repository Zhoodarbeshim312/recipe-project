      ...
      <div className="container">
        <div className="flex flex-col items-center gap-[20px]">
          ...
          <input
            ...
            className="bg-white text-[20px] rounded-[10px] px-[20px] w-[380px] h-[50px] border-2 border-[#FF9A31]"
          />
          <input
            style={{ border: "2px solid #FF9A31" }}
            type="text"
          ...
          <button
            ...
            className="bg-[#FF9A31] text-white rounded-[10px] text-[20px] px-[20px] py-[10px] w-[380px]"
          >
            Зарегистрироваться
          </button>
